...
dependencies {
    ...
    api("dev.lavalink.youtube:v2:3358633542dbb53fbfeb365bdaa5e96b869cd2cf-SNAPSHOT")
    ...
    api("com.github.topi314.lavasrc:lavasrc:4.7.0")
    api("com.github.topi314.lavasrc:lavasrc-protocol:4.7.0")
